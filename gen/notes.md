...
### Persistance: Event-driven asynchronous updates (Choreography)

- services publish events announcing that some data has changed
- other services subscribe to those events and update their data

### Persistance: Pull all updates to the same Microservice

### Persistance: Compensation / lesser Guarantees
>>>>>>> Stashed changes
