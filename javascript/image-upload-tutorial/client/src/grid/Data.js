const companies = ["Airconix", "Qualcore", "Hivemind", "Thermolock", "Sunopia"];

const firstNames = ["Raymond", "Vernon", "Dori", "Jason", "Rico"];

const lastNames = ["Neal", "Dunham", "Seabury", "Pettey", "Muldoon"];
